...
def load_emergency_services_map(location_name):
    print(f"Generating map for emergency services in {location_name}...")
    html_file = generate_map(location_name)
    if not html_file:
        return "Sorry, no emergency services found."
