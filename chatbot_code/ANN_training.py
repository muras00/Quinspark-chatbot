...
pickle.dump(words, open('instructions_words.pkl', 'wb'))
pickle.dump(classes, open('instructions_classes.pkl', 'wb'))
...
print('Training accuracy: {:.1%}'.format(hist.history['accuracy'][-1]))
#print('Validation accuracy: {:.1%}'.format(hist.history['val_accuracy'][-1]))
#print('Training time: {:.1f}s (or {:.1f} minutes)'.format(training_time_tf, training_time_tf/60))

model.save('ANN_instructions_model.keras', hist)
#print('Done')