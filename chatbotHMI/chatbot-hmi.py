...
from first_aid_engine import QueryEngine, FirstAidEngine
...
class ChatBotApp(customtkinter.CTk):
    ...
    def __init__(self, chatbot: QueryEngine) -> None:
        """Constructor"""
        super().__init__()
        ...
        self.ChatLog.configure(state=NORMAL)
        self.ChatLog.insert(END, "\n" + textwrap.fill(self.engine.new_session()) + '\n\n', ("botresponse"))
        self.ChatLog.configure(state=DISABLED)
    ...
    def button_send(self):
        ...
        if len(msg) > 0:
            ...
            # the constructor and calls the Prompt function.
            response = self.engine.prompt(msg)
